...
/*
    ...
    Lớp này dùng để lưu trữ thông tin máy chủ
     playerList -> tất cả người chơi trong máy chủ bao gồm máy chủ
     blueSlots -> các vị trí hiện có màu xanh lam
     redSlots -> các khe màu đỏ khả dụng hiện tại
*/
public class ServerInformation
{
    ...
    /// <summary>
    /// Thoát ra -1 người + 1 slot
    /// </summary>
    /// <param name="disconnectedClientId"></param>
